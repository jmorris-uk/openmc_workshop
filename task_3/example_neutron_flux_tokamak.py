...
top=150
# Create an initial uniform spatial source distribution over a shape
...
mesh_tally.scores = ['(n,t)'] #swap flux for absorption
...
flux_tally = sp.get_tally(scores=['(n,t)'])  #swap flux for absorption
flux_slice = flux_tally.get_slice(scores=['(n,t)']) #swap flux for absorption
